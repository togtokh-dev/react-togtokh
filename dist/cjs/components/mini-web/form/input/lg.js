...
function default_1(props) {
    const { value, setValue, placeholder, type, disabled, className, maxLength, inputMode, pattern, label, children, loading = false, statusList, status, addSvg = null, clearButton = true, inputClassName, labelClassName, svgClassName, onBlur = (event) => { }, onChange = (event) => { }, onFocus = (event) => { }, onClick = (event) => { }, onKeyDown = (event) => { }, childrenUse = true, } = props;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, childrenUse && children ? (react_1.default.createElement("div", { className: "react-togtokh-dev dev-input-box w-full " + className, style: {
        ...
        react_1.default.createElement("div", { className: " w-full h-full " },
                ...
                loading ? (react_1.default.createElement(react_1.default.Fragment, null, loadingSvg({
                    ...
                    type == "password" ? (react_1.default.createElement("div", null, !show
                        ...
                        : showSvg({
                            ...
                            styleConfig: styleConfig,
                        }))) : (react_1.default.createElement(react_1.default.Fragment, null, clearButton ? (react_1.default.createElement(framer_motion_1.AnimatePresence, null, focusType && (react_1.default.createElement(framer_motion_1.motion.div, { onClick: (event) => {
                            var _a;
            ...
            react_1.default.createElement("input", { id: name, ref: textInput, type: show ? "text" : type, className: "dev-input-children-icon  text-400-16 " + inputClassName, defaultValue: value, inputMode: inputMode, pattern: pattern, value: value, placeholder: focusType ? placeholder : "", onBlur: (e) => {
                ...
                }, onKeyDown: onKeyDown, disabled: disabled, style: {
