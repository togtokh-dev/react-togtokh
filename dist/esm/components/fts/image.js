    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: ` react-togtokh-dev dev-border-8  relative  dev-upload-image ${className}`, style: {
            ...
            value ? (React.createElement(React.Fragment, null,
                React.createElement(motion.label, { htmlFor: `upload-${name}`, className: "dev-upload-image-content" },
                    React.createElement("div", { className: "dev-edit" },
                ...
                " ",
                React.createElement(motion.label, { htmlFor: `upload-${name}`, className: "dev-upload-image-content" },
                    React.createElement("div", { className: "dev-edit-center text-center" },
                        React.createElement("div", { className: "dev-edit-center text-center" },
