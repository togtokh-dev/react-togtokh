...
const showSvg = ({ handleClick, styleConfig }) => {
    return (React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", onClick: handleClick },
        ...
        React.createElement("path", { d: "M14.9501 12.7803C14.7301 13.9903 13.7901 14.9403 12.6001 15.1903", stroke: styleConfig === null || styleConfig === void 0 ? void 0 : styleConfig.svgFill, "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
...
const hideSvg = ({ handleClick, styleConfig }) => {
    return (React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", onClick: handleClick },
        React.createElement("path", { d: "M12 19.25C15.81 19.25 19.29 16.5288 21.25 12C19.29 7.47123 15.81 4.75 12 4.75C8.19 4.75 4.71 7.47123 2.75 12C4.71 16.5288 8.19 19.25 12 19.25V19.25Z", stroke: styleConfig === null || styleConfig === void 0 ? void 0 : styleConfig.svgFill, "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React.createElement("path", { d: "M15 12C15 13.6614 13.6519 15 12 15C10.3481 15 9 13.6519 9 12C9 10.3386 10.3481 9 12 9C13.6614 9 15 10.3481 15 12Z", stroke: styleConfig === null || styleConfig === void 0 ? void 0 : styleConfig.svgFill, "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};
...
export default function Homepage(props) {
    ...
    return (React.createElement(React.Fragment, null, children ? (React.createElement("div", { className: "dev-input-box-web w-full  dev-border-12 " + className, style: {
        ...
        React.createElement("div", { className: " w-full h-full " },
            ...
            lable && (React.createElement("label", { htmlFor: name, className: `dev-input-lable-children-icon ${value
                    ...
                    : `${focusType
                        ? "text-400-14 dev-input-lable-deactivate"
                        : "text-400-14 dev-input-lable-active"} `}`, style: {
            ...
            React.createElement("input", { id: name, ref: textInput, type: show ? "text" : type, className: "dev-input-children-icon dev-border-12 text-400-14", defaultValue: value, inputMode: inputMode, pattern: pattern, value: value, placeholder: focusType ? placeholder : "", onBlur: (e) => {
                    setfocusType(false);
                }, onFocus: (e) => {
                    setfocusType(true);
                }, onChange: (e) => {
                ...
                } })))) : (React.createElement("div", { className: "dev-input-box-web w-full  dev-border-12 " + className, style: {
            backgroundColor: styleConfig === null || styleConfig === void 0 ? void 0 : styleConfig.bgColor,
            color: styleConfig === null || styleConfig === void 0 ? void 0 : styleConfig.textColor,
        } },
        ...
        React.createElement("input", { id: name, ref: textInput, type: show ? "text" : type, className: "dev-input dev-border-12 text-400-14", defaultValue: value, inputMode: inputMode, pattern: pattern, value: value, placeholder: focusType ? placeholder : "", onBlur: (e) => {
                setfocusType(false);
            }, onFocus: (e) => {
                setfocusType(true);
            }, onChange: (e) => {
